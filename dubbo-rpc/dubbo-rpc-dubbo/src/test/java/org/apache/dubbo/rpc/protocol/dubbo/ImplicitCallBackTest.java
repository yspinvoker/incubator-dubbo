...
public class ImplicitCallBackTest {
    ...
    public void setUp() throws SecurityException, NoSuchMethodException {
        onReturnMethod = Nofify.class.getMethod("onreturn", Person.class, Integer.class);
        onThrowMethod = Nofify.class.getMethod("onthrow", Throwable.class, Integer.class);
        onInvokeMethod = Nofify.class.getMethod("oninvoke", Integer.class);
    }
    ...
    void referService() {
        demoProxy = ProtocolUtils.refer(IDemoService.class, consumerUrl);
    }
    ...
    public void initOrResetUrl(boolean isAsync) {
    ...
    public void initImplicitCallBackURL_onlyOnthrow() {
    ...
    public void initImplicitCallBackURL_onlyOnreturn() {
    ...
    public void initImplicitCallBackURL_onlyOninvoke() {
